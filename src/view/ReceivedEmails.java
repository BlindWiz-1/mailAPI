...
public class ReceivedEmails implements Scenery {
	...
	public void view(Stage st, Sender send, Connector connectDB) {
		...
		column5.setCellValueFactory(new PropertyValueFactory<>("message"));
	...
	private ObservableList<EmailData> getEmails(Email to) {
		...
		Object[] list = connect.getEmailsSendTo(to).toArray();
